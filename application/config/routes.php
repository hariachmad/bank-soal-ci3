...
$route['mahasiswa/(:num)'] = 'Mahasiswa/masukUjian/$1';
...
$route['dosen'] = 'BankSoal/index';
$route['bankSoal/dosen'] = 'BankSoal/index';
$route['banksoal/dosen'] = 'BankSoal/index';
$route['bankSoal/(:num)/(:num)'] = 'BankSoal/daftarBab/$1/$2';
$route['bankSoal/(:num)/tambah_ujian/(:num)'] = 'Ujian/tambahUjian/$1/$2';
$route['bankSoal/(:num)/tambah_bab'] = 'BankSoal/tambahBab/$1';
$route['bankSoal/(:num)/bab/(:num)'] = 'Soal/daftarSoal/$1/$2';
$route['bankSoal/(:num)/detail_ujian/(:num)/(:num)'] = 'Ujian/detailUjian/$1/$2/$3';
$route['bankSoal/(:num)/update_ujian/(:num)/(:num)'] = 'Ujian/updateUjian/$1/$2/$3';
$route['bankSoal/(:num)/ubah_ujian/(:num)/(:num)'] = 'Ujian/ubahUjian/$1/$2/$3';
$route['bankSoal/(:num)/ubah_bab/(:num)'] = 'BankSoal/ubahBab/$1/$2';
$route['bankSoal/(:num)/hapus_ujian/(:num)/(:num)'] = 'Ujian/hapusUjian/$1/$2/$3';
$route['bankSoal/(:num)/hapus_bab/(:num)'] = 'BankSoal/hapusBab/$1/$2';
$route['bankSoal/(:num)/simpan_ujian/(:num)'] = 'Ujian/simpanUjian/$1/$2';
...
$route['banksoal/mahasiswa/(:num)']='Mahasiswa/masukUjian/$1';
$route['banksoal/ujian/mendaftar_ujian/(:num)']='Mahasiswa/mendaftarUjian/$1';
