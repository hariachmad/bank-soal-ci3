                                ...
                                <form action="/bank-soal-ci3/index.php/banksoal/hasil_ujian" method="post">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="mata_kuliah" name="mata_kuliah" required>
                                            ...
                                            <?php foreach ($hasil_ujian as $ujian): ?>
                                                <?php
                                                    if(in_array($ujian["nama_mata_kuliah"],$seen,true)){
                                                        continue;
                                                    }
                                                ?>
                                                <option value="<?php echo $ujian["nama_mata_kuliah"] ?>"> <?php echo $ujian["nama_mata_kuliah"] ?></option>
                                                <?php $seen[] = $ujian["nama_mata_kuliah"] ?>
                                            <?php endforeach ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="kode_ujian" name="kode_ujian" required>
                                            ...
                                            <?php foreach ($hasil_ujian as $ujian): ?>
                                                <?php
                                                    if(in_array($ujian["kode_ujian"],$seen,true)){
                                                        continue;
                                                    }
                                                ?>
                                                <option value="<?php echo $ujian["kode_ujian"] ?>"> <?php echo $ujian["kode_ujian"] ?></option>
                                                <?php $seen[] = $ujian["kode_ujian"] ?>
                                            <?php endforeach ?>
                                        </select>
                                    </div>
