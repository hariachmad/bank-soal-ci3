                ...
                <div class="container">
                    <div class="row">
                        <div class="col-8">
                            ...
                            <a class="btn btn-primary" href="/bank-soal-ci3-dosen/index.php/bankSoal/<?= $id; ?>">Kembali ke Daftar Bab</a>
                            <br><br>
                            <form action="/bank-soal-ci3-dosen/index.php/bankSoal/<?= $id; ?>/update_bab/<?= $bab['id']; ?>" method="post">
                                <div class="row mb-3">
                                    <label for="nomor_bab" class="col-sm-2 col-form-label">Nomor Bab</label>
                                    <div class="col-sm-10">
                                        <input type="number"
                                            id="nomor_bab" name="nomor_bab" value="<?= $bab['nomor_bab']; ?>">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text"
                                            ...
                                            id="nama_bab" name="nama_bab" value="<?= $bab['nama_bab']; ?>">
                                        <div class="invalid-feedback">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea
                                            ...
                                            id="sub_cpmk" name="sub_cpmk"><?= $bab['sub_cpmk']; ?></textarea>
                                        <div class="invalid-feedback">
