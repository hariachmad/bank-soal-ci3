            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        ...
                        <a href="/bank-soal-ci3-dosen/index.php/bankSoal/<?= $id_mata_kuliah; ?>/bab/<?= $id_bab; ?>" class="btn btn-primary">Kembali
                            ke Daftar Soal</a>
                    </div>
                </div>
                <br><br>
                <div class="row-12">
                    <form action="/banksoal/<?= $id_mata_kuliah; ?>/bab/<?= $id_bab; ?>/update_soal/<?= $soal['id']; ?>"
                        method="get">
                        <div class="row mb-3">
