    ...
    <div class="border-end" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        <a class="list-group-item list-group-item-action list-group-item-light p-3" href="#!"><img
            src="https://cdn-icons-png.flaticon.com/512/5/5178.png" class="ms-2" alt="Logo" style="width: 30px;"><span
            class="ms-2 fs-8">Ujian</span></a>
      </div>
    </div>
            ...
            <ul class="navbar-nav ms-auto mt-2 mt-lg-0 ml-auto">
              <li class="nav-item dropdown">
                <a class="nav-link" data-toggle="dropdown" href="#" style="line-height: 0.8em;">
                  <small><span class="text-uppercase"><?= $this->session->userdata("fullname") ?></span></small><br>
                </a>
    ...
    <div class="row">
        <div class="col">
            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        <td style="max-width: 800px;overflow:auto; word-wrap: break-word; white-space: pre-wrap;"><?= $soal[0]['soal'] ?></td>
                    </tr>
                </tbody>
            </table>
            <table class="table">
                ...
                <tbody>
                    <tr class="<?= ($soal[0]['jawaban_benar'] == 'jawaban_a') ? 'table-success' : '' ?>">
                        <td>A.</td>
                        <td><?= $soal[0]['jawaban_a'] ?></td>
                    </tr>
                    <tr class="<?= ($soal[0]['jawaban_benar'] == 'jawaban_b') ? 'table-success' : '' ?>">
                        <td>B.</td>
                        <td><?= $soal[0]['jawaban_b'] ?></td>
                    </tr>
                    <tr class="<?= ($soal[0]['jawaban_benar'] == 'jawaban_c') ? 'table-success' : '' ?>">
                        <td>C.</td>
                        <td><?= $soal[0]['jawaban_c'] ?></td>
                    </tr>
                    <tr class="<?= ($soal[0]['jawaban_benar'] == 'jawaban_d') ? 'table-success' : '' ?>">
                        <td>D.</td>
                        <td><?= $soal[0]['jawaban_d'] ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
